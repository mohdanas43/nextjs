...
const Guider6 = () => {
  return (
    <div className="w-screen lg:w-[50rem] px-12  " >
      <Guideinfo
        vid={
          "https://d1pwidzl9kib4u.cloudfront.net/marketing/20240305/4x3_Low_Quality_Low_Captions/20240304_Fruitful_Guide_4x3_Raquel_sm_locap.mp4"
        }
        name={"Andrew Rotz"}
